-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_index\Complex3Multiply_block22.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex3Multiply_block22
...
ENTITY Complex3Multiply_block22 IS
...
END Complex3Multiply_block22;


ARCHITECTURE rtl OF Complex3Multiply_block22 IS
...
BEGIN
  ...
  twdlXdin_28_re_tmp <= multResFP_re(21 DOWNTO 10);

  twdlXdin_28_re <= std_logic_vector(twdlXdin_28_re_tmp);

  twdlXdin_28_im_tmp <= multResFP_im(21 DOWNTO 10);
