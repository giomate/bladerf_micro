-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_index\Complex3Multiply_block13.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex3Multiply_block13
...
ENTITY Complex3Multiply_block13 IS
...
END Complex3Multiply_block13;


ARCHITECTURE rtl OF Complex3Multiply_block13 IS
...
BEGIN
  ...
  twdlXdin_18_re_tmp <= multResFP_re(21 DOWNTO 10);

  twdlXdin_18_re <= std_logic_vector(twdlXdin_18_re_tmp);

  twdlXdin_18_im_tmp <= multResFP_im(21 DOWNTO 10);
