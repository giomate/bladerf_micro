-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_index\Complex3Multiply_block18.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex3Multiply_block18
...
ENTITY Complex3Multiply_block18 IS
...
END Complex3Multiply_block18;


ARCHITECTURE rtl OF Complex3Multiply_block18 IS
...
BEGIN
  ...
  twdlXdin_23_re_tmp <= multResFP_re(21 DOWNTO 10);

  twdlXdin_23_re <= std_logic_vector(twdlXdin_23_re_tmp);

  twdlXdin_23_im_tmp <= multResFP_im(21 DOWNTO 10);
