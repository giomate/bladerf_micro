-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_index\Complex3Multiply_block26.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex3Multiply_block26
...
ENTITY Complex3Multiply_block26 IS
...
END Complex3Multiply_block26;


ARCHITECTURE rtl OF Complex3Multiply_block26 IS
...
BEGIN
  ...
  twdlXdin_32_re_tmp <= multResFP_re(21 DOWNTO 10);

  twdlXdin_32_re <= std_logic_vector(twdlXdin_32_re_tmp);

  twdlXdin_32_im_tmp <= multResFP_im(21 DOWNTO 10);
