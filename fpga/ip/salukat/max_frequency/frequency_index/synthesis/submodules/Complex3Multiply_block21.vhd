-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_index\Complex3Multiply_block21.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex3Multiply_block21
...
ENTITY Complex3Multiply_block21 IS
...
END Complex3Multiply_block21;


ARCHITECTURE rtl OF Complex3Multiply_block21 IS
...
BEGIN
  ...
  twdlXdin_27_re_tmp <= multResFP_re(21 DOWNTO 10);

  twdlXdin_27_re <= std_logic_vector(twdlXdin_27_re_tmp);

  twdlXdin_27_im_tmp <= multResFP_im(21 DOWNTO 10);
