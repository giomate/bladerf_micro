-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_index\Complex3Multiply_block38.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex3Multiply_block38
-- Source Path: max_frequency_index/max_index_frequency/FFT_streamer/FFT HDL Optimized/RADIX22FFT_SDNF1_5/Complex3Multiply
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Complex3Multiply_block38 IS
...
END Complex3Multiply_block38;


ARCHITECTURE rtl OF Complex3Multiply_block38 IS
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF enb_1_32_0 = '1' THEN
        ...
        din_vld_dly9 <= Complex3Add_prod_vld_reg1;
  ...
  dinXTwdl2_re_tmp <= multResFP_re(21 DOWNTO 10);

  dinXTwdl2_re <= std_logic_vector(dinXTwdl2_re_tmp);

  dinXTwdl2_im_tmp <= multResFP_im(21 DOWNTO 10);
