-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_index\Complex3Multiply_block20.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex3Multiply_block20
...
ENTITY Complex3Multiply_block20 IS
...
END Complex3Multiply_block20;


ARCHITECTURE rtl OF Complex3Multiply_block20 IS
...
BEGIN
  ...
  twdlXdin_26_re_tmp <= multResFP_re(21 DOWNTO 10);

  twdlXdin_26_re <= std_logic_vector(twdlXdin_26_re_tmp);

  twdlXdin_26_im_tmp <= multResFP_im(21 DOWNTO 10);
