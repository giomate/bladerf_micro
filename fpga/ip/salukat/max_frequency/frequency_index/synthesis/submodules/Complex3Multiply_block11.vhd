-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_index\Complex3Multiply_block11.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex3Multiply_block11
...
ENTITY Complex3Multiply_block11 IS
...
END Complex3Multiply_block11;


ARCHITECTURE rtl OF Complex3Multiply_block11 IS
...
BEGIN
  ...
  twdlXdin_15_re_tmp <= multResFP_re(21 DOWNTO 10);

  twdlXdin_15_re <= std_logic_vector(twdlXdin_15_re_tmp);

  twdlXdin_15_im_tmp <= multResFP_im(21 DOWNTO 10);
