-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_index\Complex3Multiply_block8.vhd
...
BEGIN
  ...
  twdlXdin_12_re_tmp <= multResFP_re(21 DOWNTO 10);

  twdlXdin_12_re <= std_logic_vector(twdlXdin_12_re_tmp);

  twdlXdin_12_im_tmp <= multResFP_im(21 DOWNTO 10);
