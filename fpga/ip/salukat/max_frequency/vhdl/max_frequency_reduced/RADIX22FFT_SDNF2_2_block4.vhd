-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_reduced\RADIX22FFT_SDNF2_2_block4.vhd
  ...
  BEGIN
    ...
    IF rotate_11 /= '0' THEN 
      IF dout_1_vld = '1' THEN 
        Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_4_re_signed, 13) + resize(dout_12_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_4_re_signed, 13) - resize(dout_12_im_signed, 13);
        Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_4_im_signed, 13) + resize(dout_12_re_signed, 13);
        Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_4_im_signed, 13) - resize(dout_12_re_signed, 13);
      END IF;
    ELSIF dout_1_vld = '1' THEN 
      Radix22ButterflyG2_NF_btf1_re_reg_next <= resize(dout_4_re_signed, 13) + resize(dout_12_re_signed, 13);
      Radix22ButterflyG2_NF_btf2_re_reg_next <= resize(dout_4_re_signed, 13) - resize(dout_12_re_signed, 13);
      Radix22ButterflyG2_NF_btf1_im_reg_next <= resize(dout_4_im_signed, 13) + resize(dout_12_im_signed, 13);
      Radix22ButterflyG2_NF_btf2_im_reg_next <= resize(dout_4_im_signed, 13) - resize(dout_12_im_signed, 13);
    END IF;
