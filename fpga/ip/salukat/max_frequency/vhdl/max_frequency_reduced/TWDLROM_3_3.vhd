-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_reduced\TWDLROM_3_3.vhd
...
-- 
-- Module: TWDLROM_3_3
-- Source Path: max_frequency_reduced/max_frequency/FFT_streamer/FFT HDL Optimized/TWDLROM_3_3
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  BEGIN
    ...
    Radix22TwdlMapping_cnt_next <= to_unsigned(16#2#, 2);
