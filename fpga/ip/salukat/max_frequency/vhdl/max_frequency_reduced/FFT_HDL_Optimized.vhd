-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_reduced\FFT_HDL_Optimized.vhd
...
-- Source Path: max_frequency_reduced/max_frequency/FFT_streamer/FFT HDL Optimized
-- Hierarchy Level: 2
-- 
-- FFT HDL Optimized
-- 
...
ARCHITECTURE rtl OF FFT_HDL_Optimized IS
  ...
  COMPONENT RADIX22FFT_SDNF2_2_block3
    PORT( clk                             :   IN    std_logic;
          ...
          dout_9_re                       :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
          dout_9_im                       :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
          dout_10_re_1                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
          dout_10_im_1                    :   OUT   std_logic_vector(11 DOWNTO 0);  -- sfix12
          dout_2_vld                      :   OUT   std_logic
          );
  END COMPONENT;
  ...
  -- Signals
  SIGNAL dataIn_re_signed                 : vector_of_std_logic_vector12(0 TO 15);  -- ufix12 [16]
  SIGNAL dataIn_im_signed                 : vector_of_std_logic_vector12(0 TO 15);  -- ufix12 [16]
  ...
  SIGNAL twdl_3_5_re                      : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL twdl_3_5_im                      : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL twdl_3_13_re                     : signed(11 DOWNTO 0);  -- sfix12_En10
  SIGNAL twdl_3_13_im                     : signed(11 DOWNTO 0);  -- sfix12_En10
  ...
  SIGNAL dataOut_re_tmp                   : vector_of_std_logic_vector12(0 TO 15);  -- ufix12 [16]
  SIGNAL dataOut_im_tmp                   : vector_of_std_logic_vector12(0 TO 15);  -- ufix12 [16]
...
BEGIN
  ...
  u_SDNF2_4_1 : RADIX22FFT_SDNF2_4
    PORT MAP( clk => clk,
              ...
              dout_2_re => dataOut_re_tmp(8),  -- sfix12
              dout_2_im => dataOut_im_tmp(8),  -- sfix12
  ...
  u_SDNF2_2_9 : RADIX22FFT_SDNF2_2_block3
    PORT MAP( clk => clk,
              ...
              dout_10_re_1 => dout_10_re_1,  -- sfix12
              dout_10_im_1 => dout_10_im_1,  -- sfix12
  ...
  u_SDNF2_2_11 : RADIX22FFT_SDNF2_2_block4
    PORT MAP( clk => clk,
              ...
              dout_12_re_1 => dout_12_re_1,  -- sfix12
              dout_12_im_1 => dout_12_im_1,  -- sfix12
  ...
  u_SDNF2_2_13 : RADIX22FFT_SDNF2_2_block5
    PORT MAP( clk => clk,
              ...
              dout_14_re_1 => dout_14_re_1,  -- sfix12
              dout_14_im_1 => dout_14_im_1,  -- sfix12
  ...
  u_SDNF2_2_15 : RADIX22FFT_SDNF2_2_block6
    PORT MAP( clk => clk,
              ...
              dout_16_re_1 => dout_16_re_1,  -- sfix12
              dout_16_im_1 => dout_16_im_1,  -- sfix12
  ...
  u_SDNF2_4_9 : RADIX22FFT_SDNF2_4_block3
    PORT MAP( clk => clk,
              ...
              dout_1_vld => dout_1_vld_1,
              softReset => softReset,
              dout_9_re_1 => dataOut_re_tmp(1),  -- sfix12
              dout_9_im_1 => dataOut_im_tmp(1),  -- sfix12
              dout_10_re => dataOut_re_tmp(9),  -- sfix12
              dout_10_im => dataOut_im_tmp(9),  -- sfix12
  ...
  u_TWDLMULT_SDNF1_3_5 : TWDLMULT_SDNF1_3_block1
    PORT MAP( clk => clk,
              ...
              dout_4_im => dout_4_im_1,  -- sfix12
              dout_2_vld => dout_2_vld,
              twdl_3_5_re => std_logic_vector(twdl_3_5_re),  -- sfix12_En10
              twdl_3_5_im => std_logic_vector(twdl_3_5_im),  -- sfix12_En10
              twdl_3_6_re => twdl_3_6_re,  -- sfix12_En10
              twdl_3_6_im => twdl_3_6_im,  -- sfix12_En10
              twdl_3_6_vld => twdl_3_6_vld,
              softReset => softReset,
  ...
  u_SDNF2_4_5 : RADIX22FFT_SDNF2_4_block1
    PORT MAP( clk => clk,
              ...
              dout_1_vld => dout_1_vld_1,
              softReset => softReset,
              dout_5_re_1 => dataOut_re_tmp(2),  -- sfix12
              dout_5_im_1 => dataOut_im_tmp(2),  -- sfix12
              dout_6_re => dataOut_re_tmp(10),  -- sfix12
              dout_6_im => dataOut_im_tmp(10),  -- sfix12
  ...
  u_TWDLMULT_SDNF1_3_13 : TWDLMULT_SDNF1_3_block5
    PORT MAP( clk => clk,
              ...
              dout_2_vld => dout_2_vld,
              twdl_3_13_re => std_logic_vector(twdl_3_13_re),  -- sfix12_En10
              twdl_3_13_im => std_logic_vector(twdl_3_13_im),  -- sfix12_En10
              twdl_3_14_re => twdl_3_14_re,  -- sfix12_En10
              twdl_3_14_im => twdl_3_14_im,  -- sfix12_En10
              twdl_3_14_vld => twdl_3_14_vld,
              softReset => softReset,
  ...
  u_SDNF2_4_13 : RADIX22FFT_SDNF2_4_block5
    PORT MAP( clk => clk,
              ...
              dout_1_vld => dout_1_vld_1,
              softReset => softReset,
              dout_13_re_1 => dataOut_re_tmp(3),  -- sfix12
              dout_13_im_1 => dataOut_im_tmp(3),  -- sfix12
              dout_14_re => dataOut_re_tmp(11),  -- sfix12
              dout_14_im => dataOut_im_tmp(11),  -- sfix12
  ...
  u_SDNF2_4_3 : RADIX22FFT_SDNF2_4_block
    PORT MAP( clk => clk,
              ...
              dout_1_vld => dout_1_vld_1,
              softReset => softReset,
              dout_3_re => dataOut_re_tmp(4),  -- sfix12
              dout_3_im => dataOut_im_tmp(4),  -- sfix12
              dout_4_re_1 => dataOut_re_tmp(12),  -- sfix12
              dout_4_im_1 => dataOut_im_tmp(12),  -- sfix12
  ...
  u_SDNF2_4_11 : RADIX22FFT_SDNF2_4_block4
    PORT MAP( clk => clk,
              ...
              dout_1_vld => dout_1_vld_1,
              softReset => softReset,
              dout_11_re => dataOut_re_tmp(5),  -- sfix12
              dout_11_im => dataOut_im_tmp(5),  -- sfix12
              dout_12_re_1 => dataOut_re_tmp(13),  -- sfix12
              dout_12_im_1 => dataOut_im_tmp(13),  -- sfix12
  ...
  u_SDNF2_4_7 : RADIX22FFT_SDNF2_4_block2
    PORT MAP( clk => clk,
              ...
              dout_1_vld => dout_1_vld_1,
              softReset => softReset,
              dout_7_re => dataOut_re_tmp(6),  -- sfix12
              dout_7_im => dataOut_im_tmp(6),  -- sfix12
              dout_8_re_1 => dataOut_re_tmp(14),  -- sfix12
              dout_8_im_1 => dataOut_im_tmp(14),  -- sfix12
  ...
  u_SDNF2_4_15 : RADIX22FFT_SDNF2_4_block6
    PORT MAP( clk => clk,
              ...
              dout_1_vld => dout_1_vld_1,
              softReset => softReset,
              dout_15_re => dataOut_re_tmp(7),  -- sfix12
              dout_15_im => dataOut_im_tmp(7),  -- sfix12
              dout_16_re_1 => dataOut_re_tmp(15),  -- sfix12
              dout_16_im_1 => dataOut_im_tmp(15),  -- sfix12
  ...
  twdl_3_5_re <= to_signed(16#400#, 12);

  twdl_3_5_im <= to_signed(16#000#, 12);

  rotate_13_1 <= '0';

  twdl_3_13_re <= to_signed(16#400#, 12);

  twdl_3_13_im <= to_signed(16#000#, 12);
