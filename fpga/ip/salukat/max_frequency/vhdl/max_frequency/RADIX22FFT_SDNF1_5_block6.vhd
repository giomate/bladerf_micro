-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency\RADIX22FFT_SDNF1_5_block6.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDNF1_5_block6 IS
  ...
  COMPONENT Complex3Multiply_block34
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex3Multiply_block34
    USE ENTITY work.Complex3Multiply_block34(rtl);
...
BEGIN
  u_MUL3_2 : Complex3Multiply_block34
    PORT MAP( clk => clk,
              reset => reset,
