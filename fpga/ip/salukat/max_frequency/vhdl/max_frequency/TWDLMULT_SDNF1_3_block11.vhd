-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency\TWDLMULT_SDNF1_3_block11.vhd
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block11 IS
  ...
  COMPONENT Complex3Multiply_block20
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex3Multiply_block20
    USE ENTITY work.Complex3Multiply_block20(rtl);
...
BEGIN
  u_MUL3_2 : Complex3Multiply_block20
    PORT MAP( clk => clk,
              reset => reset,
