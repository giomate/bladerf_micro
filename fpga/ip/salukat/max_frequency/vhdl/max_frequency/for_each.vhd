-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency\for_each.vhd
...
-- 
-- Module: for_each
-- Source Path: max_frequency/max_frequency/frequency_max/index_finder/for_each
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF for_each IS
  ...
  -- Signals
  SIGNAL Delay_ValidIn_reg                : std_logic_vector(0 TO 13);  -- ufix1 [14]
  ...
  SIGNAL qMapReal_1                       : signed(12 DOWNTO 0);  -- sfix13
  SIGNAL qMapImag_1                       : signed(12 DOWNTO 0);  -- sfix13
  ...
  SIGNAL xout1_1                          : signed(12 DOWNTO 0);  -- sfix13
  SIGNAL yout1_1                          : signed(12 DOWNTO 0);  -- sfix13
  ...
  SIGNAL xout2_1                          : signed(12 DOWNTO 0);  -- sfix13
  SIGNAL yout2_1                          : signed(12 DOWNTO 0);  -- sfix13
  ...
  SIGNAL xout3_1                          : signed(12 DOWNTO 0);  -- sfix13
  SIGNAL yout3_1                          : signed(12 DOWNTO 0);  -- sfix13
  ...
  SIGNAL xout4_1                          : signed(12 DOWNTO 0);  -- sfix13
  SIGNAL yout4_1                          : signed(12 DOWNTO 0);  -- sfix13
  ...
  SIGNAL xout5_1                          : signed(12 DOWNTO 0);  -- sfix13
  SIGNAL yout5_1                          : signed(12 DOWNTO 0);  -- sfix13
  ...
  SIGNAL xout6_1                          : signed(12 DOWNTO 0);  -- sfix13
  SIGNAL yout6_1                          : signed(12 DOWNTO 0);  -- sfix13
  ...
  SIGNAL xout7_1                          : signed(12 DOWNTO 0);  -- sfix13
  SIGNAL yout7_1                          : signed(12 DOWNTO 0);  -- sfix13
  ...
  SIGNAL xout8_1                          : signed(12 DOWNTO 0);  -- sfix13
  SIGNAL yout8_1                          : signed(12 DOWNTO 0);  -- sfix13
  ...
  SIGNAL xout9_1                          : signed(12 DOWNTO 0);  -- sfix13
  SIGNAL yout9_1                          : signed(12 DOWNTO 0);  -- sfix13
  ...
  SIGNAL xout10_1                         : signed(12 DOWNTO 0);  -- sfix13
  SIGNAL yout10_1                         : signed(12 DOWNTO 0);  -- sfix13
  ...
  SIGNAL xout11_1                         : signed(12 DOWNTO 0);  -- sfix13
  ...
  SIGNAL outSwitchMag_1                   : signed(12 DOWNTO 0);  -- sfix13
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      Delay_ValidIn_reg(0) <= '0';
      Delay_ValidIn_reg(1) <= '0';
      Delay_ValidIn_reg(2) <= '0';
      Delay_ValidIn_reg(3) <= '0';
      Delay_ValidIn_reg(4) <= '0';
      Delay_ValidIn_reg(5) <= '0';
      Delay_ValidIn_reg(6) <= '0';
      Delay_ValidIn_reg(7) <= '0';
      Delay_ValidIn_reg(8) <= '0';
      Delay_ValidIn_reg(9) <= '0';
      Delay_ValidIn_reg(10) <= '0';
      Delay_ValidIn_reg(11) <= '0';
      Delay_ValidIn_reg(12) <= '0';
      Delay_ValidIn_reg(13) <= '0';
  ...
  BEGIN
    IF reset = '1' THEN
      qMapReal_1 <= to_signed(16#0000#, 13);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_32_0 = '1' THEN
        qMapReal_1 <= qMapReal;
      END IF;
  ...
  BEGIN
    IF reset = '1' THEN
      qMapImag_1 <= to_signed(16#0000#, 13);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_32_0 = '1' THEN
        qMapImag_1 <= qMapImag;
      END IF;
  ...
  BEGIN
    IF reset = '1' THEN
      outSwitchMag_1 <= to_signed(16#0000#, 13);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_32_0 = '1' THEN
