-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency\RADIX22FFT_SDNF1_5_block8.vhd
...
ARCHITECTURE rtl OF RADIX22FFT_SDNF1_5_block8 IS
  ...
  COMPONENT Complex3Multiply_block36
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex3Multiply_block36
    USE ENTITY work.Complex3Multiply_block36(rtl);
...
BEGIN
  u_MUL3_2 : Complex3Multiply_block36
    PORT MAP( clk => clk,
              reset => reset,
