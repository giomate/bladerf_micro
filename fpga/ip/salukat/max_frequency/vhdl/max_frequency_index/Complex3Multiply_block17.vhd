-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_index\Complex3Multiply_block17.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex3Multiply_block17
...
ENTITY Complex3Multiply_block17 IS
...
END Complex3Multiply_block17;


ARCHITECTURE rtl OF Complex3Multiply_block17 IS
...
BEGIN
  ...
  twdlXdin_22_re_tmp <= multResFP_re(21 DOWNTO 10);

  twdlXdin_22_re <= std_logic_vector(twdlXdin_22_re_tmp);

  twdlXdin_22_im_tmp <= multResFP_im(21 DOWNTO 10);
