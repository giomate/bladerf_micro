-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_index\TWDLMULT_SDNF1_3_block6.vhd
...
ARCHITECTURE rtl OF TWDLMULT_SDNF1_3_block6 IS
  ...
  COMPONENT Complex3Multiply_block11
    PORT( clk                             :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  COMPONENT Complex3Multiply_block12
    PORT( clk                             :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : Complex3Multiply_block11
    USE ENTITY work.Complex3Multiply_block11(rtl);

  FOR ALL : Complex3Multiply_block12
    USE ENTITY work.Complex3Multiply_block12(rtl);
...
BEGIN
  u_MUL3_1 : Complex3Multiply_block11
    PORT MAP( clk => clk,
  ...
  u_MUL3_2 : Complex3Multiply_block12
    PORT MAP( clk => clk,
              enb_1_32_0 => enb_1_32_0,
