-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_index\Complex3Multiply_block.vhd
...
BEGIN
  ...
  twdlXdin_3_re_tmp <= multResFP_re(21 DOWNTO 10);

  twdlXdin_3_re <= std_logic_vector(twdlXdin_3_re_tmp);

  twdlXdin_3_im_tmp <= multResFP_im(21 DOWNTO 10);
