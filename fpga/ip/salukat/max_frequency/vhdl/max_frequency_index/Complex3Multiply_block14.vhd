-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_index\Complex3Multiply_block14.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex3Multiply_block14
...
ENTITY Complex3Multiply_block14 IS
...
END Complex3Multiply_block14;


ARCHITECTURE rtl OF Complex3Multiply_block14 IS
...
BEGIN
  ...
  twdlXdin_19_re_tmp <= multResFP_re(21 DOWNTO 10);

  twdlXdin_19_re <= std_logic_vector(twdlXdin_19_re_tmp);

  twdlXdin_19_im_tmp <= multResFP_im(21 DOWNTO 10);
