-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_index\Complex3Multiply_block23.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex3Multiply_block23
...
ENTITY Complex3Multiply_block23 IS
...
END Complex3Multiply_block23;


ARCHITECTURE rtl OF Complex3Multiply_block23 IS
...
BEGIN
  ...
  twdlXdin_29_re_tmp <= multResFP_re(21 DOWNTO 10);

  twdlXdin_29_re <= std_logic_vector(twdlXdin_29_re_tmp);

  twdlXdin_29_im_tmp <= multResFP_im(21 DOWNTO 10);
