-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_index\Complex3Multiply_block19.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex3Multiply_block19
...
ENTITY Complex3Multiply_block19 IS
...
END Complex3Multiply_block19;


ARCHITECTURE rtl OF Complex3Multiply_block19 IS
...
BEGIN
  ...
  twdlXdin_24_re_tmp <= multResFP_re(21 DOWNTO 10);

  twdlXdin_24_re <= std_logic_vector(twdlXdin_24_re_tmp);

  twdlXdin_24_im_tmp <= multResFP_im(21 DOWNTO 10);
