-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_index\Complex3Multiply_block16.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex3Multiply_block16
...
ENTITY Complex3Multiply_block16 IS
...
END Complex3Multiply_block16;


ARCHITECTURE rtl OF Complex3Multiply_block16 IS
...
BEGIN
  ...
  twdlXdin_21_re_tmp <= multResFP_re(21 DOWNTO 10);

  twdlXdin_21_re <= std_logic_vector(twdlXdin_21_re_tmp);

  twdlXdin_21_im_tmp <= multResFP_im(21 DOWNTO 10);
