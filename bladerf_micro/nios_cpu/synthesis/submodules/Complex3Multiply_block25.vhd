-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_index\Complex3Multiply_block25.vhd
...
-- Source Path: max_frequency_index/max_index_frequency/FFT_streamer/FFT HDL Optimized/TWDLMULT_SDNF1_3/Complex3Multiply
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Complex3Multiply_block25 IS
  ...
  SIGNAL Complex3Add_tmpResult_reg        : signed(25 DOWNTO 0) := to_signed(16#0000000#, 26);  -- sfix26
  SIGNAL Complex3Add_multRes_re_reg1      : signed(24 DOWNTO 0) := to_signed(16#0000000#, 25);  -- sfix25
  SIGNAL Complex3Add_multRes_re_reg2      : signed(24 DOWNTO 0) := to_signed(16#0000000#, 25);  -- sfix25
  SIGNAL Complex3Add_multRes_im_reg       : signed(26 DOWNTO 0) := to_signed(16#0000000#, 27);  -- sfix27
  SIGNAL Complex3Add_prod_vld_reg1        : std_logic := '0';
  SIGNAL Complex3Add_prodOfSum_reg        : signed(25 DOWNTO 0) := to_signed(16#0000000#, 26);  -- sfix26
