-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_index\Complex3Multiply_block24.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex3Multiply_block24
...
ENTITY Complex3Multiply_block24 IS
...
END Complex3Multiply_block24;


ARCHITECTURE rtl OF Complex3Multiply_block24 IS
...
BEGIN
  ...
  twdlXdin_30_re_tmp <= multResFP_re(21 DOWNTO 10);

  twdlXdin_30_re <= std_logic_vector(twdlXdin_30_re_tmp);

  twdlXdin_30_im_tmp <= multResFP_im(21 DOWNTO 10);
