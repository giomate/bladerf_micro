-- -------------------------------------------------------------
-- 
-- File Name: D:\Salukat\Development\Software\Quartus\BladeRF\hdl\fpga\ip\salukat\max_frequency\vhdl\max_frequency_index\Complex3Multiply_block15.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Complex3Multiply_block15
...
ENTITY Complex3Multiply_block15 IS
...
END Complex3Multiply_block15;


ARCHITECTURE rtl OF Complex3Multiply_block15 IS
...
BEGIN
  ...
  twdlXdin_20_re_tmp <= multResFP_re(21 DOWNTO 10);

  twdlXdin_20_re <= std_logic_vector(twdlXdin_20_re_tmp);

  twdlXdin_20_im_tmp <= multResFP_im(21 DOWNTO 10);
