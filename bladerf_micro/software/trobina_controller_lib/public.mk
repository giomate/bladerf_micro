...
ALT_INCLUDE_DIRS += $(ALT_LIBRARY_ROOT_DIR)/../../../../../Hardware/BladeRF/hdl/quartus/work/bladerf-micro-A4-hosted/software/ad9361_lib
ALT_INCLUDE_DIRS += $(ALT_LIBRARY_ROOT_DIR)/../adf5610_lib
...
ALT_LIBRARY_NAMES += trobina_controller_lib

# Library dependencies for the linker.
# This is the full pathname of the library (*.a) file.
ALT_LDDEPS += $(ALT_LIBRARY_ROOT_DIR)/libtrobina_controller_lib.a
